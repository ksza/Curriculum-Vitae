...
\begin{tabular}{rl}
    ...
    \textsc{Address:}   	 &  Øresundskollegiet, Dalslandsgade 8, E 204, 2300,
    København S, Denmark \\ \textsc{Phone:}     	 & +45 502 85 221\\
...
\begin{tabular}{p{2.5cm}|p{11cm}}
 ...
 were developed in Tcl/Tk. Also part of the resposibilities was the update of
 the project documentation: design papers, iterface descriptions and user
 manuals.}\\ 
 ...
 the functionality and refactored existing code. Responsible with the developement
