...
%\raggedleft \textsc{January 2012} & Software Developer at \textsc{\href{http://www.noitso.dk/}{noitso}}, Copenhagen, Denmark \\
% \raggedleft \textsc{Present}\\ & My responsibilities, so far, were to develop new functionality into an existing project, \textsc{ScoreEngine} -- 
%a scoring machine which provides an accurate assessment of your customers. \\
...
\multicolumn{2}{c}{} \\ 
\textsc{Technologies} & XML, Swing, log4j, jUnit, Spring, Hibernate,
 GWT, Restlet, Servlet, JSP, JSF, MySQL, Microsoft SQL Server, couchDB, .NET, ADO.NET Entity Framework, Windows Workflow Foundation\\ 
 \multicolumn{2}{c}{} \\
